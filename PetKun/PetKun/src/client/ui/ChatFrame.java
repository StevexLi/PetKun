...
public class ChatFrame extends JFrame{
    ...
    public ChatFrame(){
        ...
        this.setFont(new Font("MS Mincho",Font.PLAIN, 36));
    }

    public void init(){
        this.setTitle("PetKun聊天");
        ...
        infoPanel.setFont(new Font("MS Mincho",Font.PLAIN, 36));
        //右下连发送消息面板
        JPanel sendPanel = new JPanel();
        sendPanel.setLayout(new BorderLayout());
        sendPanel.setFont(new Font("MS Mincho",Font.PLAIN, 36));
        ...
        msgListArea.setFont(new Font("MS Mincho",Font.PLAIN, 36));
        JPanel tempPanel = new JPanel();
        tempPanel.setLayout(new BorderLayout());
        sendPanel.add(tempPanel, BorderLayout.NORTH);
        tempPanel.setFont(new Font("MS Mincho",Font.PLAIN, 36));
        ...
        sendPanel.add(new JScrollPane(sendArea,
                JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
                JScrollPane.HORIZONTAL_SCROLLBAR_NEVER));
        sendArea.setFont(new Font("MS Mincho",Font.PLAIN, 36));
